"""
Tests for the rust_textrank Python API.
"""
...
def test_import():
    ...
    import rust_textrank

    assert hasattr(rust_textrank, "__version__")
    assert hasattr(rust_textrank, "BaseTextRank")
    assert hasattr(rust_textrank, "PositionRank")
    assert hasattr(rust_textrank, "BiasedTextRank")


def test_version():
    """Test version string is valid."""
    from rust_textrank import __version__
...
class TestTextRankConfig:
    ...
    def test_default_config(self):
        ...
        from rust_textrank import TextRankConfig
...
class TestJsonInterface:
    ...
    def test_extract_from_json(self):
        ...
        from rust_textrank import extract_from_json
    ...
    def test_batch_from_json(self):
        ...
        from rust_textrank import extract_batch_from_json
