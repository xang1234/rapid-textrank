"""
spaCy pipeline component for rust_textrank.

This module provides a spaCy pipeline component that uses rust_textrank
for keyword extraction. It can be used as a drop-in replacement for
pytextrank with significantly better performance.

Example:
    >>> import spacy
    >>> from rust_textrank.spacy_component import RustTextRank
    >>>
    >>> nlp = spacy.load("en_core_web_sm")
    >>> nlp.add_pipe("rust_textrank")
    >>>
...
from rust_textrank._rust import extract_from_json
